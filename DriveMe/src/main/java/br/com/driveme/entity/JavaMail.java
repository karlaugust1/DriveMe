...
public class JavaMail {
	...
	public void enviarEmail(String email) {
        ...
        try {
              ...
              message.setSubject("Bem-vindo a ABC Auto Peças!");//Assunto
              message.setText("Nós da ABC Auto Peças, juntamente com o sistema DriveMe, agradecemos a confiança e prezamos o seu gosto acima de tudo. Muito obrigado por se registrar!");
